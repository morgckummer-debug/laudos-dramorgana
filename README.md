...
- `cervical-doppler.html` — Ultrassonografia da Região Cervical com Estudo Doppler (planos musculares/subcutâneo, linfonodos por nível cervical — I, IIA, IIB, III, IV, V, VI, VII — com listas dinâmicas independentes para direita e esquerda, cada linfonodo com nível, forma, ecogenicidade e menor eixo; o menor eixo tem um limite de referência por nível, 10 mm no nível II e 9 mm nos demais, com aviso quando ultrapassado; padrão de vascularização ao Doppler). Tem um botão "Ver mapa dos níveis" que abre `linfonodos.png` (mapa dos níveis cervicais) num popup, para apoio na hora de classificar o nível. Traz nota de rodapé fixa sobre a Tireóide não fazer parte desta avaliação, por normatização do CBR. Sem CPF e sem integração com a Curva de Crescimento — não tem feto, nada a gravar em `patients`/`gestacoes`/`exams`.
